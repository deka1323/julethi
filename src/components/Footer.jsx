      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            />
            <p className="text-white text-xs mb-4">by Zinku</p>
          ...
          {/* Shop Section */}
          <div>
            <h3 className="text-base font-semibold text-yellow-300 mb-4">Shop</h3>
            <ul className="space-y-2">
              <li><Link to="/shop" className="text-teal-300 hover:text-white transition-colors text-sm">All Collection</Link></li>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex space-x-4 mt-4">
                <a href="https://instagram.com/julethi_by_zinku" target="_blank" rel="noopener noreferrer"
                  className="text-teal-300 hover:text-yellow-300 transition-colors">
                  <Instagram className="h-4 w-4" />
                </a>
                <a href="https://www.facebook.com/zinkumk/" target="_blank" rel="noopener noreferrer"
                  className="text-teal-300 hover:text-yellow-300 transition-colors">
